...
extern Cliente cadastro[MAX_CADASTROS]; /*A variável cadastro define a quantidade de clientes que podem ser armazenados no banco, onde cada um assumirá uma posição em ordem crescente de 0 a 999*/
